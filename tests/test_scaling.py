...
class TestDataScaling:
    ...
    @pytest.mark.parametrize(
        "dt_id, scaler, exp_mean, exp_var, exp_min, exp_max", [
            (0, "min-max", [0.10972805, 0.18916243], [0.04092028, 0.07842329],
             [0, 0], [1, 1]),
            (2, "min-max", [0.4287037, 0.43916667, 0.46757062, 0.45777778], [
                0.05255573, 0.03242199, 0.08883726, 0.10043951
            ], [0, 0, 0, 0], [1, 1, 1, 1]),
            (0, "robust", [0.82562938, 1.33437416], [3.45558848, 8.99152336],
             [-0.18271619, -0.69111064], [9.0067807, 10.01653805]),
            (2, "robust", [0.03333333, 0.108, -0.16895238, -0.06755556], [
                0.4030309, 0.74700267, 0.25244285, 0.25712514
            ], [-1.15384615, -2., -0.95714286, -0.8],
             [1.61538462, 2.8, 0.72857143, 0.8]),
            (0, "standard", [0, 0], [1, 1], [-0.54243585, -0.67547977],
             [4.40102076, 2.89541848]),
            (2, "standard", [0, 0, 0, 0], [1, 1, 1, 1], [
